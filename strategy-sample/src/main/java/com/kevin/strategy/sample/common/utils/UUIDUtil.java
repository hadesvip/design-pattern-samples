...
public class UUIDUtil {
  ...
  private static final long TIMESTAMP_LEFT_SHIFT =
      SEQUENCE_BITS + WORKER_ID_BITS + DATACENTERIDBITS;

  private static final long SEQUENCE_MASK = ~(-1L << SEQUENCE_BITS);

  private static final UUIDUtil ID_WORKER_UTILS = new UUIDUtil();
  ...
  private UUIDUtil(final long workerId, final long datacenterId, final long idepoch) {
